...
- The route map is a local schematic, not a network-tile map, so it cannot fail into a giant blank/world map.
- Every important movement has a Google Maps fallback.
